...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('portal_authtoken', (
        ...
        db.send_create_signal('portal', ['AuthToken'])


    def backwards(self, orm):
        # Deleting model 'AuthToken'
        db.delete_table('portal_authtoken')
    ...
    models = {
        ...
        'portal.authtoken': {
            'Meta': {'object_name': 'AuthToken', 'ordering': "('-modified', '-created')"},
